# ArtiusID Android SDK v1.2.20

A secure Android SDK for identity verification, face liveness detection, document scanning, and NFC passport reading.

## 📦 Installation

1. Download `artiusid-sdk-1.2.20.aar` from the [releases page](https://github.com/artius-iD/artiusid_sdk_android/releases)
...
```gradle
dependencies {
    implementation files('libs/artiusid-sdk-1.2.20.aar')
