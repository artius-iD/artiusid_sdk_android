...
data class StandaloneVerificationResultData(
    // Personal/Risk data
    ...
    companion object {
        ...
        fun fromPayload(payload: String?): StandaloneVerificationResultData {
            if (payload.isNullOrEmpty()) {
                return StandaloneVerificationResultData(
                    personScore = 0.0,
                    personResult = null,
                    personRating = null
                )
            ...
            return try {
                ...
                StandaloneVerificationResultData(
                ...
                android.util.Log.e("StandaloneVerificationResultData", "Error parsing payload JSON", e)
                StandaloneVerificationResultData(
                    personScore = 0.0,
                    personResult = null,
                    personRating = null
        ...
        private fun getDocumentNames(): Pair<String?, String?> {
            return try {
                ...
                // TODO: Implement proper document data access
                // For now, return default values
                
                // Fallback to default
                Pair("User", null)
            } catch (e: Exception) {
                android.util.Log.e("StandaloneVerificationResultData", "Error getting document names", e)
                Pair("User", null)
            }
        }
    }
